...
public class NotesResource {
     ...
     */
    @PutMapping("/notes/{id}")
    public Mono<ResponseEntity<Notes>> updateNotes(@PathVariable(value = "id", required = false) final UUID id, @RequestBody Notes notes)
            ...
            .flatMap(exists -> {
                ...
                Mono<Notes> result = notesRepository
                    ...
                    .map(existingNotes -> {
                        ...
                        if (notes.getSongId() != null) {
                            existingNotes.setSongId(notes.getSongId());
                        }
     ...
     */
    @GetMapping("/notes/{id}")
    public Mono<ResponseEntity<Notes>> getNotes(@PathVariable UUID id) {
    ...
    public Mono<ResponseEntity<Void>> deleteNotes(@PathVariable UUID id) {
