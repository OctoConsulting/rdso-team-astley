...
public class SongResource {
     ...
     */
    @PutMapping("/songs/{id}")
    public Mono<ResponseEntity<Song>> updateSong(@PathVariable(value = "id", required = false) final UUID id, @RequestBody Song song)
     ...
     */
    @GetMapping("/songs/{id}")
    public Mono<ResponseEntity<Song>> getSong(@PathVariable UUID id) {
