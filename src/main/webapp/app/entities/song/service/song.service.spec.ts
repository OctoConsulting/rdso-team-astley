  ...
  describe('Service methods', () => {
    ...
    describe('addSongToCollectionIfMissing', () => {
      it('should add a Song to an empty array', () => {
        const song: ISong = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      ...
      it("should add a Song to an array that doesn't contain it", () => {
        const song: ISong = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
        const songCollection: ISong[] = [{ id: '1361f429-3817-4123-8ee3-fdf8943310b2' }];
        expectedResult = service.addSongToCollectionIfMissing(songCollection, song);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(song);
      });
      ...
      it('should add only unique Song to an array', () => {
        const songArray: ISong[] = [
          { id: '9fec3727-3421-4967-b213-ba36557ca194' },
          { id: '1361f429-3817-4123-8ee3-fdf8943310b2' },
          { id: '07ad28b3-ac2a-49b7-b119-4f7dcd4113e0' },
        ];
        const songCollection: ISong[] = [{ id: '9fec3727-3421-4967-b213-ba36557ca194' }];
      ...
      it('should accept varargs', () => {
        const song: ISong = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
        const song2: ISong = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
