...
export class WriterService {
  ...
  update(writer: IWriter): Observable<EntityResponseType> {
    return this.http.put<IWriter>(`${this.resourceUrl}/${getWriterIdentifier(writer) as string}`, writer, { observe: 'response' });
  }

  partialUpdate(writer: IWriter): Observable<EntityResponseType> {
    return this.http.patch<IWriter>(`${this.resourceUrl}/${getWriterIdentifier(writer) as string}`, writer, { observe: 'response' });
  }
