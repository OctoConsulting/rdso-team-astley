...
class NotesResourceIT {
    ...
    public static Notes createEntity(EntityManager em) {
        Notes notes = new Notes().userId(DEFAULT_USER_ID).songId(DEFAULT_SONG_ID).note(DEFAULT_NOTE);
        return notes;
    }
    ...
    public static Notes createUpdatedEntity(EntityManager em) {
        Notes notes = new Notes().userId(UPDATED_USER_ID).songId(UPDATED_SONG_ID).note(UPDATED_NOTE);
        return notes;
    }
