...
class NotesResourceIT {
    ...
    private static final UUID DEFAULT_SONG_ID = UUID.randomUUID();
    private static final UUID UPDATED_SONG_ID = UUID.randomUUID();
    ...
    public static Notes createEntity(EntityManager em) {
        Notes notes = new Notes().id(UUID.randomUUID()).userId(DEFAULT_USER_ID).songId(DEFAULT_SONG_ID).note(DEFAULT_NOTE);
        return notes;
    }
    ...
    public static Notes createUpdatedEntity(EntityManager em) {
        Notes notes = new Notes().id(UUID.randomUUID()).userId(UPDATED_USER_ID).songId(UPDATED_SONG_ID).note(UPDATED_NOTE);
        return notes;
    }
    ...
    void createNotes() throws Exception {
        ...
        assertThat(testNotes.getSongId()).isEqualTo(DEFAULT_SONG_ID);
    ...
    void getAllNotes() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.[*].id")
            .value(hasItem(notes.getId().toString()))
            .jsonPath("$.[*].userId")
            .value(hasItem(DEFAULT_USER_ID.toString()))
            .jsonPath("$.[*].songId")
            .value(hasItem(DEFAULT_SONG_ID.toString()))
            .jsonPath("$.[*].note")
    ...
    void getNotes() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.id")
            .value(is(notes.getId().toString()))
            .jsonPath("$.userId")
            .value(is(DEFAULT_USER_ID.toString()))
            .jsonPath("$.songId")
            .value(is(DEFAULT_SONG_ID.toString()))
            .jsonPath("$.note")
    ...
    void putNewNotes() throws Exception {
        ...
        updatedNotes.userId(UPDATED_USER_ID).songId(UPDATED_SONG_ID).note(UPDATED_NOTE);
        ...
        assertThat(testNotes.getSongId()).isEqualTo(UPDATED_SONG_ID);
    ...
    void partialUpdateNotesWithPatch() throws Exception {
        ...
        partialUpdatedNotes.userId(UPDATED_USER_ID).songId(UPDATED_SONG_ID).note(UPDATED_NOTE);
