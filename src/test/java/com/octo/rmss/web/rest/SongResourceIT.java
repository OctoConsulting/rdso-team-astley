...
class SongResourceIT {
    ...
    @Test
    void checkWriterIsRequired() throws Exception {
        int databaseSizeBeforeTest = songRepository.findAll().collectList().block().size();
        // set the field null
        song.setWriter(null);
    ...
    @Test
    void checkPerformerIsRequired() throws Exception {
        int databaseSizeBeforeTest = songRepository.findAll().collectList().block().size();
        // set the field null
    ...
    @Test
    void checkSoundtrackIsRequired() throws Exception {
        int databaseSizeBeforeTest = songRepository.findAll().collectList().block().size();
        // set the field null
        song.setSoundtrack(null);
    ...
    @Test
    void checkTrackNumberIsRequired() throws Exception {
        int databaseSizeBeforeTest = songRepository.findAll().collectList().block().size();
        // set the field null
