...
class WriterResourceIT {
    ...
    public static Writer createEntity(EntityManager em) {
        Writer writer = new Writer().id(UUID.randomUUID()).name(DEFAULT_NAME).songId(DEFAULT_SONG_ID);
        return writer;
    }
    ...
    public static Writer createUpdatedEntity(EntityManager em) {
        Writer writer = new Writer().id(UUID.randomUUID()).name(UPDATED_NAME).songId(UPDATED_SONG_ID);
        return writer;
    }
    ...
    void getAllWriters() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.[*].id")
            .value(hasItem(writer.getId().toString()))
            .jsonPath("$.[*].name")
    ...
    void getWriter() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.id")
            .value(is(writer.getId().toString()))
            .jsonPath("$.name")
